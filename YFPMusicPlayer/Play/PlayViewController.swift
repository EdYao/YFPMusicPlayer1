...
class PlayViewController: BaseViewController {
    ...
    func startPlay() {
        ...
        player.play()
        playOrPauseBtn.setBackgroundImage(UIImage(named: "pause"), for: UIControl.State.normal)
        isPlaying = true
    }
    ...
    func pause() {
        ...
        player.pause()
        playOrPauseBtn.setBackgroundImage(UIImage(named: "play"), for: UIControl.State.normal)
        isPlaying = false
    }
